...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Achievement.icon_image'
        db.add_column('core_achievement', 'icon_image',
                      self.gf('django.db.models.fields.TextField')(default='-'),
                      keep_default=False)

        # Adding field 'Achievement.standard_image'
        db.add_column('core_achievement', 'standard_image',
                      self.gf('django.db.models.fields.TextField')(default='-'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Achievement.icon_image'
        db.delete_column('core_achievement', 'icon_image')

        # Deleting field 'Achievement.standard_image'
        db.delete_column('core_achievement', 'standard_image')
