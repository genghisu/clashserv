...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_rating', (
            ...
            ('target_model', self.gf('django.db.models.fields.TextField')(default='')),
            ('target_name', self.gf('django.db.models.fields.TextField')(default='')),
        ...
        # Adding model 'TotalRating'
        db.create_table('core_totalrating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target_model', self.gf('django.db.models.fields.TextField')(default='')),
            ('target_name', self.gf('django.db.models.fields.TextField')(default='')),
            ('total_rating', self.gf('django.db.models.fields.IntegerField')(default=50)),
            ('rating_count', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal('core', ['TotalRating'])

        # Adding model 'Tip'
        db.create_table('core_tip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target_model', self.gf('django.db.models.fields.TextField')(default='')),
            ('target_name', self.gf('django.db.models.fields.TextField')(default='')),
            ('tip', self.gf('django.db.models.fields.TextField')(default='')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal('core', ['Tip'])

    def backwards(self, orm):
        # Deleting model 'Rating'
        db.delete_table('core_rating')

        # Deleting model 'TotalRating'
        db.delete_table('core_totalrating')

        # Deleting model 'Tip'
        db.delete_table('core_tip')
