...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExperienceLevel'
        db.create_table('core_experiencelevel', (
        ...
        db.send_create_signal('core', ['ExperienceLevel'])

    def backwards(self, orm):
        # Deleting model 'ExperienceLevel'
        db.delete_table('core_experiencelevel')
