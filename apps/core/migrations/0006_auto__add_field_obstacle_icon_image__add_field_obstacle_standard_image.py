...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Obstacle.icon_image'
        db.add_column('core_obstacle', 'icon_image',
                      self.gf('django.db.models.fields.TextField')(default='-'),
                      keep_default=False)

        # Adding field 'Obstacle.standard_image'
        db.add_column('core_obstacle', 'standard_image',
                      self.gf('django.db.models.fields.TextField')(default='-'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Obstacle.icon_image'
        db.delete_column('core_obstacle', 'icon_image')

        # Deleting field 'Obstacle.standard_image'
        db.delete_column('core_obstacle', 'standard_image')
