...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_achievement', (
            ...
            ('exp_reward', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('crystal_reward', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['Achievement'])

    def backwards(self, orm):
        # Deleting model 'Achievement'
        db.delete_table('core_achievement')
