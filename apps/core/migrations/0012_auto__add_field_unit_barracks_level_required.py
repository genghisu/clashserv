...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.barracks_level_required'
        db.add_column('core_unit', 'barracks_level_required',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Unit.barracks_level_required'
        db.delete_column('core_unit', 'barracks_level_required')
