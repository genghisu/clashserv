...
def paginate_queryset(queryset,  per_page,  body,  page):
    paginator = DiggPaginator(queryset, per_page, body = body)
    current_page = paginator.page(page)
    page_range = paginator.page_range
    return current_page,  page_range

def paginate_queryset_ajax(queryset,  per_page,  body,  page,  unique_id = 'default',  source = None):
    paginator = DiggPaginator(queryset, per_page, body = body)
    current_page = paginator.page(page)
    current_page.unique_id = unique_id
    current_page.source = source
    page_range = paginator.page_range
    return current_page,  page_range
